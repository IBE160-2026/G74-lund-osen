...
17. **Product Brief er låst.** Briefen er arbeidskravet: den skal være på 1–2
    ...
    Gjeldende tag er `arbeidskrav-product-brief-v6`; de eldre taggene står
    ...
    endres før fristen, lages en ny tag med neste ledige nummer (`-v7`, `-v8`
    …); en tag flyttes aldri. Versjon 6 er om lag 750 ord og fyller to sider, så
