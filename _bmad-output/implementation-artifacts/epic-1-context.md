...
- **`Kursrad`** har `dato` (`datetime.date`), `slutt`, `justert_slutt` og
  ...
  fra `adjusted_close` til `close`. Beregning bruker justert kurs, mens
...
- **Skjemaendringer bare via nummererte migrasjoner** med `skjema_versjon`.
  ...
  skrives ikke før løperen og adapteren er herdet (1.5b).
...
- **Etter Epic 1:** kodegjennomgang med `bmad-code-review` (åpent punkt 22). En
  første gjennomgang ble gjort etter 1.1–1.3, og funnene står som
  forutsetninger i 1.5b og 2.2.
