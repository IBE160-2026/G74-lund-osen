...
| KI-bidrag i drift | Hvilke meldinger KI-laget forklarte eller omklassifiserte som regelfilteret alene ikke skilte | Dokumentert eksempelsett fra minst to ukers drift | Før demonstrasjon |
| Relevanseksperiment | Testsett på 50 medieartikler merket manuelt, kjørt mot både symbolmatching og KI-klassifisering | Eksperimentet gjennomført og tallene dokumentert — ikke at KI kommer best ut | Uke 40 |
...
Relevanseksperimentet er et avgrenset delprosjekt, ikke en del av driften. Viser målingen liten forskjell, er det også et funn: eksperimentet skal avgjøre påstanden, ikke bekrefte den. Vi setter ikke mål for hvor godt signalene treffer markedet.
